...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=utf8 COMMENT='Modulos del sistema';
...
INSERT INTO `hr_app_modulo` VALUES (13,'Cliente','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-29 00:56:14',NULL,NULL),(16,'Usuario','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 17:34:26',NULL,NULL),(19,'Modulo','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 17:34:40',NULL,NULL),(21,'Perfil','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 17:34:40',NULL,NULL),(22,'PerfilesModulos','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 17:34:40',NULL,NULL),(47,'Test','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-07-30 17:34:40',NULL,NULL),(53,'Modulos','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-08-01 03:01:03',NULL,NULL),(54,'Perfiles','2016-06-01 00:00:00','2018-06-01 00:00:00','dbo','2016-08-01 03:01:03',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Perfiles de seguridad';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hr_app_perfil` VALUES (1,'Administrador','2016-06-01 00:00:00','2020-06-01 00:00:00','-1','2016-06-01 18:23:41',NULL,NULL),(3,'Test','2016-06-01 00:00:00','2020-06-01 00:00:00','test','2016-07-30 18:23:41',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='Relacion perfiles-modulo';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hr_app_perfil_modulo` VALUES (1,1,13,'dbo','2016-07-30 21:19:16',NULL,NULL),(2,1,19,'dbo','2016-07-30 21:37:59',NULL,NULL),(4,1,21,'dbo','2016-07-30 21:49:28',NULL,NULL),(13,1,22,'dbo','2016-08-01 03:17:36',NULL,NULL),(14,1,16,'dbo','2016-08-01 03:00:00',NULL,NULL);
...
INSERT INTO `hr_app_session_keys` VALUES ('4b6084ec-2b6e-11e6-a94e-c04a00011902',2,'2016-06-05 20:09:04','2016-06-05 22:39:04'),('8084d8c4-2b79-11e6-a94e-c04a00011902',2,'2016-06-05 21:29:18','2016-06-05 23:59:18'),('a223e322-3657-11e6-a49b-c04a00011902',2,'2050-01-01 00:00:00','2016-06-19 19:54:29'),('02a89193-3b17-11e6-a1f2-c04a00011902',2,'2016-06-25 18:24:29','2016-06-25 20:54:29');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='Tabla de usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `hr_app_usuario` VALUES (1,'master','Administrador','Sistema','uranga.rodrigo@gmail.com','a7f585ec50901f4da974c82a679f5d2b',1,'2016-01-01',NULL,'dbo','2016-04-27 19:43:09',NULL,NULL),(2,'admin','Administrador','Sistema','p.haddad.p@gmail.com','4297f44b13955235245b2497399d7a93',1,'2016-01-01',NULL,'dbo','2016-04-27 19:43:09',NULL,NULL),(3,'test','nombre','apellido','test@com.ar','4297f44b13955235245b2497399d7a93',1,'2016-01-01','2018-01-01','test','2016-08-16 01:06:56',NULL,NULL);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getSessionKeyByUser`(pUserName varchar(20),pPassword varchar(50))
BEGIN
    ...
    */
    ...
    IF vId_usuario  IS NOT NULL THEN 
        ...
        IF vUUID  IS NOT NULL THEN 
			SELECT a.id_usuario,a.uuid ,a.expiration
			FROM hr_app_session_keys a
			WHERE a.id_usuario=vId_usuario and a.expiration>NOW();
        ELSE
...
BEGIN
    select a.id_perfil,a.id_modulo
...
BEGIN
    INSERT INTO hr_app_perfil_modulo(id_perfil,id_modulo,creado_por,fecha_modificacion)
        VALUES(pId_Perfil,pId_Modulo,pCreado_Por,pFecha_Modificacion);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2016-08-15 22:42:57
